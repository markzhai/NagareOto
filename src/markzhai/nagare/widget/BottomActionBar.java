package markzhai.nagare.widget;

import static markzhai.nagare.Constants.SIZE_THUMB;
import static markzhai.nagare.Constants.SRC_FIRST_AVAILABLE;
...
import markzhai.nagare.activity.AudioPlayerHolder;
...
public class BottomActionBar extends LinearLayout implements OnClickListener, OnLongClickListener {
    ...
    public void updateBottomActionBar(Activity activity) {
        ...
        if (MusicUtils.mService != null && MusicUtils.getCurrentAudioId() != -1) {
            ...
            mInfo.data = new String[] { String.valueOf(MusicUtils.getCurrentAlbumId()),
