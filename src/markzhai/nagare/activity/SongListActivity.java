...
import markzhai.nagare.R.id;
import markzhai.nagare.R.layout;
import markzhai.nagare.fragment.SongDetailFragment;
import markzhai.nagare.fragment.SongListFragment;
...
public class SongListActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.song_detail_container) != null) {
            ...
            ((SongListFragment) getSupportFragmentManager().findFragmentById(
                    R.id.song_list)).setActivateOnItemClick(true);
        }
